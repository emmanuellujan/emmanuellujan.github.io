...
![](/assets/CESMIX.jpg)
@@
[Julia & AI to scale the chemical diversity of machine learning interatomic potentials]
...
![](/assets/nbiot.jpg)
@@
[5G NB-IoT to connect sensors in extreme environments]
...
@@
[Modeling & simulation to unravel electroporation in cancer treatments]
...
![](/assets/tumor.jpg)
@@
[Exploring tumor growth through diffusion–convection modeling]
...
* [Fast density functional theory for training machine learning interatomic potentials via large-scale atomistic sampling.]
  ...
  **E. Lujan**, S. Wyant, and R. Alomairy.
